...
src_path = 'D:/Data_seg/MICCAI_BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData'
tar_path = 'D:/Data_seg/BRATS2020_Training_canny_npy'
...
name_list = [x for x in os.listdir(src_path)]
...
for file_name in name_list:
    ...
    edge_path = 'D:/Data_seg/BRATS2020_Training_canny_npy/seg/' + case_id+'_canny.npy'
    edge_data = np.load(edge_path)
    edge_data = edge_data.astype(np.uint8)
    edge_data1 = edge_data[x_min:x_max, y_min:y_max, z_min:z_max]
    np.save(os.path.join(tar_path, 'seg_crop', case_id+'_canny.npy'), edge_data1)
